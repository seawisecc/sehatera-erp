  ...
  return (
    <div className="sw-scene" aria-hidden="true">
      ...
      <svg
        ...
        role="presentation"
      >
        {/* Seluruh isi digeser turun: kanvasnya sengaja lebih tinggi daripada
            layar supaya `slice` memotong dari LANGIT, bukan dari bangunan. */}
        <g transform="translate(0 300)">
        {/* ── Awan ─────────────────────────────────────────────── */}
        <g fill="var(--surface)" opacity="0.5">
        ...
        <path
          ...
          stroke="var(--on-grad)" strokeWidth="2.5" fill="none" opacity="0.3"
        ...
        {/* ── Kota jauh ────────────────────────────────────────── */}
        <g fill="var(--on-grad)" opacity="0.1">
        ...
        {/* ══ RUMAH SAKIT (kiri) ═══════════════════════════════════ */}
        <g>
          <rect x="-40" y="300" width="420" height="420" rx="10" fill="var(--on-grad)" opacity="0.24" />
          {/* atap & helipad */}
          <rect x="20" y="268" width="290" height="34" rx="6" fill="var(--on-grad)" opacity="0.28" />
          ...
          {/* kanopi IGD */}
          <rect x="40" y="612" width="230" height="40" rx="6" fill="var(--brand)" opacity="0.55" />
        ...
        {/* ══ APOTEK (kanan) ═══════════════════════════════════════ */}
        <g>
          <rect x="1230" y="360" width="430" height="360" rx="10" fill="var(--on-grad)" opacity="0.2" />
          {/* papan nama */}
          <rect x="1230" y="360" width="430" height="62" rx="8" fill="var(--brand)" opacity="0.72" />
        ...
        <g fill="var(--on-grad)" opacity="0.42">
          <rect x="0" y="720" width="1600" height="180" />
        </g>
        <g fill="var(--on-grad)" opacity="0.62">
